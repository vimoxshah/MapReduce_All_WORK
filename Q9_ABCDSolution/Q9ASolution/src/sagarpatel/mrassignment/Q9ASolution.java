...
public class Q9ASolution {
	...
	public static void main(String args[]) 
		...
		job1.setJarByClass(Q9ASolution.class);
		...
		job2.setJarByClass(Q9ASolution.class);
		
		job2.setMapperClass(Q9AMapper.class);
		job2.setReducerClass(Q9AReducer.class);
		
		job2.setOutputKeyClass(ClassSchoolNameWritable.class);
		job2.setOutputValueClass(StudentCompositeMarksInfoWritable.class);
